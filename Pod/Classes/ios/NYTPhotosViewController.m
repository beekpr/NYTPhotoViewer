...
- (instancetype)initWithPhotos:(NSArray *)photos initialPhoto:(id <NYTPhoto>)initialPhoto delegate:(id <NYTPhotosViewControllerDelegate>)delegate {
    ...
    if (self) {
        ...
        UIImage *closeButtonImage = [UIImage imageNamed:@"NYTPhotoViewerCloseButtonX" inBundle:classBundle compatibleWithTraitCollection:nil];
        UIImage *closeButtonLandscapeImage = [UIImage imageNamed:@"NYTPhotoViewerCloseButtonXLandscape" inBundle:classBundle compatibleWithTraitCollection:nil];
        ...
        _overlayView.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:closeButtonImage landscapeImagePhone:closeButtonLandscapeImage style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonTapped:)];
...
- (void)setupPageViewControllerWithInitialPhoto:(id <NYTPhoto>)initialPhoto {
    ...
    [initialPhotoViewController photoViewControllerIsCurrentlyDisplayed:YES];
...
- (void)pageViewController:(UIPageViewController *)pageViewController didFinishAnimating:(BOOL)finished previousViewControllers:(NSArray *)previousViewControllers transitionCompleted:(BOOL)completed {
    if (completed) {
        ...
        for (NYTPhotoViewController *previousViewController in previousViewControllers) {
            if ([previousViewController respondsToSelector:@selector(photoViewControllerIsCurrentlyDisplayed:)]) {
                [previousViewController photoViewControllerIsCurrentlyDisplayed:NO];
            }
        }
        
        NYTPhotoViewController *photoViewController = pageViewController.viewControllers.firstObject;
        [photoViewController photoViewControllerIsCurrentlyDisplayed:YES];
